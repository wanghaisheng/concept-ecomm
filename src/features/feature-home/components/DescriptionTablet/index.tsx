...
const DescriptionTablet = ({ name, price }: DescriptionTabletProps) => {
  return (
    <div className="mx-s24 flex max-h-[76px] w-full justify-between rounded-full bg-white/20 px-s24 py-s20 border-gradient-b-custom-gradient sm:max-h-[104px] sm:max-w-[465px] sm:px-s24 sm:py-s20 md:max-h-[104px] md:max-w-[465px] md:px-s40 md:py-s24 lg:max-h-[104px] lg:max-w-[465px] lg:gap-s24 lg:px-s40  lg:py-s24">
