...
const buttonVariants = cva(['inline-flex justify-center items-center rounded-[100px]'], {
  variants: {
    ...
    variant: {
      ...
      icon: 'bg-background-white/80  bg-blend-color-dodge shadow-sm hover:shadow-lg max-h-[44px]  h-[44px] hover:bg-blend-color-lighten h-[44px]  w-[44px] rounded-full p-s10',
      unstyled: '',
      'outline-white':
